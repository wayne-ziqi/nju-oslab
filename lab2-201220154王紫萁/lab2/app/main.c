...
int uEntry(void) {
	...
	printf("=======================================================\n");
	printf("Now let's test scanf, input a decimal, a hexadecimal, a string and a character\n");
	int decimal;
	uint32_t hexadecimal;
	char string[20];
	char ch;
	scanf(" decimal=%d, hexadecimal=%x, string=%s character=%c", &decimal, &hexadecimal, &string, &ch);
	printf("your input is %d, %x, %s, %c, am I right?\n", decimal, hexadecimal, string, ch);
	printf("=======================================================\n");
